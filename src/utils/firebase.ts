...
// Инициализация с новым non-blocking cache API (заменяет устаревший enableIndexedDbPersistence)
// persistentLocalCache не блокирует main thread при старте — в отличие от deprecated enableIndexedDbPersistence
