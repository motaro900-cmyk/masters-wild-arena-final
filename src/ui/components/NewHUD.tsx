        ...
        <>
            <div className="w-screen h-screen bg-black flex items-center justify-center overflow-hidden font-sans select-none pointer-events-none">
                ...
                >
                    ...
                    <EditorPanel
                        id="NewLeftPanel"
                        className="absolute left-10 top-10 bottom-10 w-[400px] flex flex-col gap-6 z-20 pointer-events-auto"
                    >
                        {/* Профиль */}
                        <div className="bg-black/40 backdrop-blur-md rounded-3xl p-5 border border-white/10 shadow-2xl">
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-1 w-full">
                                    ...
                                    <div className="text-blue-400 font-bold mb-2 text-sm uppercase tracking-wider">
                                        Уровень 15
                                    </div>
                        ...
                        <div className="flex-1 bg-black/40 backdrop-blur-md rounded-3xl p-4 border border-white/10 flex flex-col gap-3 shadow-2xl overflow-y-auto">
                            ...
                            {['ЗВЕРИ', 'ИНВЕНТАРЬ', 'МАГАЗИН', 'КЛАНЫ', 'РЕЙТИНГ'].map((item) => (
                                <button
                                    key={item}
                                    className="flex items-center gap-4 px-6 py-4 rounded-2xl bg-black/20 text-white/80 font-bold text-xl hover:bg-white/10 hover:text-white hover:scale-105 transition-all duration-200 border border-transparent hover:border-white/10"
                                >
                                    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path
                                            strokeLinecap="round"
                            ...
                            <button className="flex items-center gap-4 px-6 py-4 rounded-2xl bg-black/20 text-white/80 font-bold text-xl hover:bg-white/10 hover:text-white hover:scale-105 transition-all duration-200 border border-transparent hover:border-white/10">
                                <div className="relative">
                                    ...
                                    <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs font-black px-2 py-0.5 rounded-full border-2 border-slate-900">
                                        2
                                    </span>
                                </div>
                                ПОЧТА
                        ...
                        <div className="bg-black/40 backdrop-blur-md rounded-3xl p-5 border border-white/10 shadow-2xl flex flex-col gap-3">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-2xl font-black text-yellow-400 tracking-wider drop-shadow-md">
                                        СЕЗОН 3
                                    </span>
                                </div>
                            </div>
                    ...
                    <EditorPanel
                        id="NewTopRightPanel"
                        className="absolute top-10 right-10 flex gap-5 z-20 pointer-events-auto"
                    >
                        {[
                            {
                                icon: (
                            ...
                            },
                            {
                                icon: (
                                    <svg className="w-8 h-8 text-purple-400" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M2.11 7.11C2.622 6.598 3.514 6 4.5 6h11c.986 0 1.878.598 2.39 1.11M12 2v4M8 2v4M4 10h16v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6z" />
                                    </svg>
                                ),
                                val: '1,200',
                            ...
                            <div
                                key={i}
                                className="flex items-center bg-black/40 backdrop-blur-md rounded-full pr-1 pl-5 py-1.5 border border-white/10 shadow-xl hover:scale-105 transition-transform cursor-pointer"
                            >
                                <div className="mr-3 drop-shadow-[0_0_10px_currentColor]">{res.icon}</div>
                                <span
                                    className={`text-2xl font-black tracking-wide mr-5 ${res.color} drop-shadow-md`}
                    ...
                    <EditorPanel
                        id="NewStatsPanel"
                        className="absolute right-10 top-1/2 -translate-y-1/2 w-[380px] bg-black/40 backdrop-blur-md rounded-3xl p-8 border border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.8)] z-20 pointer-events-auto"
                    >
                        <div className="text-center mb-8 border-b border-white/10 pb-6">
                            <h1
                                className="text-5xl font-black text-white tracking-widest drop-shadow-[0_4px_4px_rgba(0,0,0,1)] mb-2"
                                style={{ WebkitTextStroke: '1.5px black' }}
                            >
                                ПАНДА
                            </h1>
                            <div className="text-orange-400 font-black uppercase tracking-[0.2em] text-sm mb-2 drop-shadow-md">
                                Легендарный
                            </div>
                            <div className="inline-block bg-white/10 px-4 py-1 rounded-full text-white/80 font-black text-lg border border-white/5">
                                LVL 12
                            </div>
                        </div>
                            ...
                            {[
                                ...
                                <div key={stat.name} className="flex flex-col gap-2">
                                    <div className="flex justify-between items-end">
                                        <div className="flex items-center gap-3">
                                            {stat.icon}
                                            <span className="text-white/80 font-bold text-xl uppercase tracking-wide">
                                                {stat.name}
                                            </span>
                                        </div>
                                        <span
                                    ...
                                    <div className="h-2 w-full bg-black/60 rounded-full overflow-hidden border border-white/5 relative">
                                        <div
                                            className={`absolute inset-y-0 left-0 ${stat.color} ${stat.glow}`}
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-gradient-to-b from-yellow-400 via-orange-500 to-red-600 rounded-[50px] flex items-center justify-center overflow-hidden shadow-[inset_0_4px_15px_rgba(255,255,255,0.5)] border border-yellow-300">
                                ...
                                <div className="flex items-center gap-6 z-10">
                                    <svg
                                        className="w-20 h-20 text-white drop-shadow-[0_4px_4px_rgba(0,0,0,0.4)]"
                                        fill="currentColor"
                                        viewBox="0 0 20 20"
                                    >
                                        <path
                                    ...
                                    <div className="flex flex-col items-start -mt-2">
                                        <span
                                            className="text-[80px] leading-none font-black text-white tracking-widest drop-shadow-[0_6px_6px_rgba(0,0,0,0.6)]"
                                            style={{
                                                WebkitTextStroke: '2.5px #5a1e00',
                                                textShadow: '0px 10px 0px rgba(90,30,0,0.5)',
                                            }}
                                        >
                                            В БОЙ!
                                        </span>
                                        <span className="text-2xl font-black text-yellow-200 tracking-[0.3em] uppercase drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)] ml-2 mt-1">
                                            MASTERS OF THE WILD
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div className="absolute -top-6 -right-6 bg-slate-900 border-4 border-yellow-500 text-white font-black text-2xl px-6 py-2 rounded-2xl shadow-[0_10px_20px_rgba(0,0,0,0.6)] flex items-center gap-2 transform rotate-6 group-hover:rotate-12 transition-transform duration-300">
                                <svg
                                    className="w-8 h-8 text-blue-400 drop-shadow-[0_0_8px_rgba(96,165,250,0.8)]"
                                    fill="currentColor"
                                    viewBox="0 0 20 20"
                                >
                                    <path
                    ...
                    <div className="absolute inset-0 pointer-events-none z-[100]">
                        {Object.values(useUIStore((state: any) => state.elements))
                            .filter((el: any) => el.type !== 'sprite')
                            .map((el: any) => {
                                return (
                                    <div
                                        key={el.id}
                                    ...
                                    >
                                        {el.text && (
                                            <div
                                                ...
                                                style={{ color: el.color || el.tint || 'white' }}
                                            >
                                                {el.text}
                                            </div>
                                        )}
