...
const SvgIcon = {
    Trophy: () => (
        <svg viewBox="0 0 24 24" width="14" height="14" fill="#fbbf24">
            <path d="M18 2h-3v2h3v2h-1.07c-.45 2.71-2.22 4.96-4.93 5.76V15h3v2h-3v2h-2v-2H7v-2h3v-3.24c-2.71-.8-4.48-3.05-4.93-5.76H4V6h3V4H4V2h3V0h10v2z" />
        </svg>
    ),
};
        ...
        <div className="absolute top-3 left-4 right-4 flex justify-between items-start pointer-events-none z-50">
                ...
                <div className="ml-3 flex flex-col flex-1 h-full justify-between py-0.5">
                    <div className="flex justify-between items-start gap-2">
                        <div className="flex flex-col leading-none">
                            <h2 className="text-lg font-black text-white uppercase tracking-tighter truncate max-w-[100px]">
                                {heroName}
                            </h2>
                            <p className="text-[8px] font-black text-amber-500 uppercase mt-0.5 whitespace-nowrap">
                                ЛЕГЕНДА ДВОРА
                            </p>
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex-1 h-1.5 bg-black/60 rounded-full border border-white/5 overflow-hidden">
                            <div
                                className="h-full bg-gradient-to-r from-orange-400 to-amber-500 relative"
            ...
            <div className="flex gap-2 pointer-events-auto mt-1">
                {[
                    ...
                    <div
                        key={i}
                        className="flex items-center bg-[#1c1f26] border-2 border-[#3d4149] rounded-xl pl-2 pr-1 py-1 gap-2 h-10 min-w-[115px] shadow-xl"
                    >
                        ...
                        <button className="w-7 h-7 bg-[#26a541] hover:bg-[#1e8534] rounded-lg border-b-[3px] border-[#145a23] text-white font-black text-lg active:translate-y-0.5 transition-all">
                            +
                        </button>
                    </div>
                ))}
