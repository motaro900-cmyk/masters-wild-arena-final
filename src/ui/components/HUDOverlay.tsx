    ...
    return (
        <DndContext onDragEnd={handleDragEnd}>
            <div className="absolute inset-0 w-full h-full pointer-events-none z-[10] font-game tracking-wide">
                ...
                <EditableUIElement
                    id="topbar-avatar"
                    bgSrc={resolveAssetPath('/assets/ui/panel_wood.png')}
                    width={300}
                    height={100}
                />
                <EditableUIElement
                    id="topbar-bp"
                    bgSrc={resolveAssetPath('/assets/ui/panel_dark.png')}
                    width={400}
                    height={80}
                />
                <EditableUIElement
                    id="topbar-res"
                    bgSrc={resolveAssetPath('/assets/ui/panel_gold.png')}
                    width={350}
                    height={60}
                />
                ...
                <EditableUIElement
                    id="left-beasts"
                    bgSrc={resolveAssetPath('/assets/ui/btn_side.png')}
                    width={220}
                    height={70}
                />
                <EditableUIElement
                ...
                <EditableUIElement
                    id="right-gift"
                    bgSrc={resolveAssetPath('/assets/ui/btn_green.png')}
                    width={320}
                    height={100}
                />
                <EditableUIElement
                    id="right-quests"
                    bgSrc={resolveAssetPath('/assets/ui/panel_parchment.png')}
                    width={320}
                    height={300}
                />
                ...
                <EditableUIElement
                    id="bottom-battle"
                    bgSrc={resolveAssetPath('/assets/ui/btn_mega_gold.png')}
                    width={400}
                    height={120}
                />
                ...
                <EditableUIElement
                    id="bottom-social"
                    bgSrc={resolveAssetPath('/assets/ui/btn_icon.png')}
                    width={80}
                    height={80}
                />
            </div>
