            ...
            <div style={{
                ...
                <div className="flex justify-between items-end">
                    <div className="flex flex-col">
                        <span style={{ color: '#a0a0a0', fontSize: '12px', fontWeight: 'bold', textTransform: 'uppercase' }}>Ваш Статус</span>
                        <span style={{ 
                            color: '#f0c040', 
                            fontSize: '32px', 
                            fontWeight: 900, 
                ...
                <div className="flex flex-col gap-2">
                    {benefits.map((b, i) => (
                        <div key={i} style={{
                            ...
                            <span style={{ fontSize: '28px', filter: b.unlocked ? 'none' : 'grayscale(1) opacity(0.5)' }}>{b.icon}</span>
                            <span style={{ 
                            ...
                            {b.unlocked ? (
                                <span style={{ marginLeft: 'auto', color: '#f0c040', fontSize: '20px', fontWeight: 'bold' }}>АКТИВНО</span>
                            ) : (
                                <span style={{ marginLeft: 'auto', color: '#5a4a3a', fontSize: '12px', fontWeight: 'bold' }}>ЗАБЛОКИРОВАНО</span>
                            )}
                        </div>
                    ))}
                </div>
