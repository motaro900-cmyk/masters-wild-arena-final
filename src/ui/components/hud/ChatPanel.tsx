...
export const ChatPanel: React.FC = () => {
    ...
    const filteredMessages = messages.filter((msg: any) => {
        ...
        if (activeChatTab === 'private') {
            ...
            if (privateRecipient) {
                return (msg.type === 'private' || msg.type === 'personal') && 
    ...
    return (
        <div style={{
                            ...
                            {EMOJI_TABS.map(tab => (
                                <div 
                                    ...
                                    style={{
                                        ...
                                        border: activeTab === tab.id ? '1px solid rgba(240, 192, 64, 0.3)' : '1px solid transparent',
                                        transition: 'all 0.2s',
                ...
                {[
                    ...
                    >
                        ...
                        {tab.id === 'private' && privateRecipient && (
                            <span style={{ fontSize: '9px', background: '#f0c040', color: '#000', padding: '1px 5px', borderRadius: '4px' }}>
                                1
                            </span>
                        )}
                    </div>
            ...
            <div style={{
                background: activeChatTab === 'private' && privateRecipient 
                    ...
                    {activeChatTab === 'private' && privateRecipient && (
                        ...
                        >
                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                <div style={{ 
                                    width: 8, height: 8, background: '#f0c040', borderRadius: '50%',
                                ...
                                <span style={{ 
                                    ...
                                    ПРИВАТНЫЙ ЧАТ: <span style={{ color: '#fff', fontSize: '13px' }}>{privateRecipient}</span>
                                </span>
                            </div>
                            <div 
                    ...
                    {filteredMessages.length === 0 && activeChatTab === 'private' && (
                        <div style={{
                            ...
                            <span style={{ 
                                ...
                                ВЫБЕРИТЕ ИГРОКА<br/>ЧТОБЫ НАЧАТЬ ДИАЛОГ
                            </span>
                        </div>
                    )}
                        ...
                        <div key={msg.id} style={{ 
                            ...
                            {msg.type === 'system' ? (
                                ...
                                <div style={{ 
                                    ...
                                    gap: 8, 
                                    flexWrap: 'wrap',
                                    background: msg.author === 'ГЕРОЛЬД' ? 'linear-gradient(90deg, rgba(240, 192, 64, 0.2), transparent)' : 'transparent',
                                    ...
                                    {msg.rankIcon && (
                                        <img 
                                            src={msg.rankIcon.includes('rank_') ? msg.rankIcon : `/assets/images/ui/rank_01.png`} 
                                            alt="rank" 
                                            style={{ 
                                                width: 32,
                                                height: 32, 
                                    ...
                                    {msg.vipLevel > 0 && (
                                        <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', marginRight: '2px' }}>
                                            <img 
                                     ...
                                     <span 
                                         ...
                                         style={{ 
                                             ...
                                             textShadow: msg.isTop1 
                                                 ...
                                                 : (msg.vipLevel > 0 ? '0 0 8px rgba(240, 192, 64, 0.4)' : '0 1px 2px rgba(0,0,0,0.5)'),
                                             letterSpacing: '0.5px',
                                             fontFamily: "'Cinzel', serif",
                ...
                <div style={{
                    ...
                    >
                         {activeChatTab === 'private' && privateRecipient && (
                            <div style={{
                                ...
                                alignItems: 'center',
                                gap: '8px',
                                background: 'linear-gradient(135deg, rgba(240, 192, 64, 0.25), rgba(138, 90, 16, 0.15))',
                                padding: '5px 12px',
                                borderRadius: '8px',
                                ...
                                <span style={{ fontSize: '10px', color: '#f0c040', fontWeight: 900, fontFamily: "'Cinzel', serif", letterSpacing: '0.5px' }}>
                                    {privateRecipient}
                                </span>
                                <span 
                                    onClick={(e) => { e.stopPropagation(); setPrivateRecipient(null); }}
                                    style={{ 
                                        cursor: 'pointer', 
                                        color: '#fff', 
                                        fontSize: '14px', 
                        ...
                        <div 
                            ...
                            onMouseEnter={e => e.currentTarget.style.opacity = '1'}
                            onMouseLeave={e => { if(!showEmoji) e.currentTarget.style.opacity = '0.6' }}
                        >
                            😊
                        </div>
                    </div>
                    ...
                    <button 
                        ...
                        style={{
                            width: 50,
                            height: 42,
                            background: inputText.trim() ? 'linear-gradient(180deg, #f0c040, #8a5a10)' : 'rgba(240, 192, 64, 0.1)',
                            border: '1px solid rgba(240, 192, 64, 0.4)',
                            borderRadius: '10px',
            ...
            <AnimatePresence>
                {contextMenu.visible && (
                    ...
                    >
                        <div style={{ padding: '4px 8px', fontSize: '10px', color: '#f0c040', borderBottom: '1px solid rgba(240, 192, 64, 0.2)', marginBottom: '4px', fontWeight: 800 }}>
                            {contextMenu.author}
                        </div>
                        {[
                            { label: '👤 Профиль', action: () => console.log('Profile', contextMenu.author) },
                            { label: '💬 Написать ЛС', action: () => {
                                setActiveChatTab('private');
                            ...
                            { label: '📋 Копировать ник', action: () => navigator.clipboard.writeText(contextMenu.author || '') }
                        ].map(item => (
                            <div 
                                key={item.label}
