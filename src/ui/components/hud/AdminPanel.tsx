                    ...
                    <div style={contentGrid}>
                        ...
                        <Section title="ИНВЕНТАРЬ & ТЕЛЕПОРТ">
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    Object.keys(ITEMS_DATABASE).forEach((id) =>
                                        store.addItemToInventory({ id, level: 1 }),
                                    );
                            ...
                            <ToggleRow
                                ...
                                onToggle={() =>
                                    store.setHasInfiniteEnergy && store.setHasInfiniteEnergy(!store.hasInfiniteEnergy)
                                }
                            />
                        </Section>
                    </div>
                            ...
                            {selectedPlayer ? (
                                <>
                                    ...
                                    >
                                        ...
                                        />
                                        <div style={{ flex: 1 }}>
                                            <h2 style={{ margin: 0, color: '#f0c040', fontSize: '24px' }}>
                                                {selectedPlayer.name}
                                            </h2>
                                    ...
                                    <Section title="БЫСТРОЕ РЕДАКТИРОВАНИЕ ПАРАМЕТРОВ (Modify Selected Player)">
                                        <div style={editRow}>
                                            ...
                                            <button
                                                onClick={() => handleRemoteUpdate('золото', serverPlayerGold)}
                                                style={applyBtn}
                                            >
                                                SET
                                            </button>
                                        ...
                                        <div style={editRow}>
                                            ...
                                            <button
                                                onClick={() => handleRemoteUpdate('лев', serverPlayerLevel)}
                                                style={applyBtn}
                                            >
                                                SET
                                            </button>
                                        ...
                                        >
                                            {selectedPlayer.reportLogs.length > 0
                                                ? selectedPlayer.reportLogs.map((log, i) => (
                                                      <div
                                                          key={i}
                                                          style={{ padding: '2px 0', borderBottom: '1px solid #111' }}
                                                      >
                                                          • {log}
                                                      </div>
                                                  ))
                                            ...
                                            <div style={{ display: 'flex', gap: '5px' }}>
                                                ...
                                                <button
                                                    onClick={async () => {
                                                        ...
                                                        if (!selectedPlayer) return;
                                                        try {
                                                            await syncService.updateRemotePlayerData(
                                                                selectedPlayer.id,
                                                                {
                                                                    status: 'BANNED',
                                                                    banReason: modReason,
                                ...
                                <div
                                    style={{ color: '#222', textAlign: 'center', marginTop: '220px', fontSize: '14px' }}
                                >
                                    ...
                                    {mailAttachments.length > 0 ? (
                                        mailAttachments.map((a) => (
                                            ...
                                            >
                                                ...
                                                <span
                                                    onClick={() =>
                                                        setMailAttachments(mailAttachments.filter((x) => x.id !== a.id))
                                                    }
