...
export const DailyGiftWindow: React.FC<DailyGiftWindowProps> = ({ onClose }) => {
    ...
    useEffect(() => {
        const checkStatus = () => {
            ...
            const isSameDay = mskNow.getDate() === mskLast.getDate() && 
    ...
    return (
        <div style={{
            ...
            alignItems: 'center', justifyContent: 'center', padding: '20px', gap: '20px',
            ...
            <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        >
                            <img 
                                ...
                                alt="chest" 
                                style={{ width: '100%', height: '100%', objectFit: 'contain', filter: 'drop-shadow(0 0 30px rgba(240,192,64,0.4))' }} 
                            />
                        </motion.div>
                        <h2 style={{ 
                        ...
                        <div style={{
                            ...
                            <div className="flex items-center gap-2">
                                <img src={AssetsMap.UI.ICON_GOLD_FULL} style={{ width: 16, height: 16, objectFit: 'contain', filter: 'contrast(1.2) brightness(1.1)' }} alt="gold" />
                                <span style={{ color: '#f0c040', fontWeight: 900, fontSize: '12px' }}>до 1000</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <img src={AssetsMap.UI.ICON_ALMAZ_FULL} style={{ width: 16, height: 16, objectFit: 'contain', filter: 'contrast(1.2) brightness(1.1)' }} alt="gems" />
                                <span style={{ color: '#c084fc', fontWeight: 900, fontSize: '12px' }}>до 20</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <img src={AssetsMap.UI.ICON_ENERGY_FULL} style={{ width: 16, height: 16, objectFit: 'contain', filter: 'contrast(1.2) brightness(1.1)' }} alt="energy" />
                                <span style={{ color: '#fff', fontWeight: 900, fontSize: '12px' }}>до 10</span>
                            </div>
                        </div>

                        <p style={{ color: '#8a7a6a', fontSize: 13, marginTop: 15, fontWeight: 'bold', opacity: 0.8 }}>Нажми на сундук, чтобы забрать награду</p>
                    </motion.div>
                )}
                ...
                {status === 'CLAIMED' && reward && (
                    ...
                    >
                        ...
                        <button 
                            ...
                            style={{
                                marginTop: 65, padding: '16px 60px', background: 'linear-gradient(180deg, #f0c040, #8a5a10)',
                                border: 'none', borderRadius: 12, color: '#000', fontFamily: "'Cinzel', serif",
                                fontWeight: 900, fontSize: 18, cursor: 'pointer', boxShadow: '0 8px 25px rgba(0,0,0,0.5)',
                                transition: 'all 0.2s'
                            }}
                ...
                {status === 'CLAIMED' && !reward && (
                    ...
                    >
                        <div style={{ width: 160, height: 160, opacity: 0.4, filter: 'grayscale(0.8) sepia(1) hue-rotate(-20deg)' }}>
                            <img src={AssetsMap.UI.ICON_DAILY_CHEST} alt="wait" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                        </div>
                        ...
                        <div style={{
                            ...
                            <p style={{ color: '#8a7a6a', fontSize: 14, textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '5px' }}>
