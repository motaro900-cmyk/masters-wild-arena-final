...
export const BattleHUD = React.memo<BattleHUDProps>(
    ({ enemyData, battleMode, activePveEnemy, battleState, playerPulse, enemyPulse, currentAttacker, liveLog }) => {
        ...
        const enemyLevel =
            precomputedEnemyLevel !== undefined
                ? precomputedEnemyLevel
                : battleMode === 'PVE' && activePveEnemy
                  ? activePveEnemy.level || 1
                  : activeRankedOpponent?.level || 1;
        const enemyRating =
            precomputedEnemyRating !== undefined
                ? precomputedEnemyRating
                : battleMode === 'PVE' && activePveEnemy
                  ? Math.max(0, (activePveEnemy.level || 1) * 180)
                  : activeRankedOpponent?.rating || 0;
        ...
        return (
            <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 100 }}>
                ...
                >
                    ...
                    <BattleVSPanel timeLeft={timeLeft} lastLog={lastLog} scale={scale} formatTime={formatTime} />
