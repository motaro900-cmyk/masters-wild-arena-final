...
import { getAvatarFrameStyle, getAvatarFramePath } from '../../../../configs/ProfileCustomization';
...
interface EnemyPanelProps {
    ...
    enemyAvatar: string;
    activeRankedOpponent: any;
    battleMode: string;
    enemyLevel: number;
    enemyName: string;
    enemyRank: { name: string; icon: string; glow: string };
    enemyRating: number;
    battleState: {
...
export const EnemyPanel = React.memo<EnemyPanelProps>(({
    enemyPulse,
    currentAttacker,
    enemyAvatar,
    ...
    return (
        ...
        >
            ...
            {/* Nickname, Rank, Trophies (Symmetric, right-aligned) */}
            <div
                style={{
                    position: 'absolute',
                    right: '140px',
