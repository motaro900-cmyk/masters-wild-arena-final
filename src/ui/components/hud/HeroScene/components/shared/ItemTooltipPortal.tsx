                    ...
                    <div style={{ display: 'flex', gap: '25px', marginBottom: '20px' }}>
                        <div style={{ width: '100px', height: '100px', background: 'rgba(255,255,255,0.03)', borderRadius: '15px', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '1px solid rgba(255,255,255,0.08)' }}>
                            {itemData.spriteClass ? (
                                ...
                                <img src={itemData.image} style={{ width: '85%', height: '85%', objectFit: 'contain' }} alt="" />
                            )}
                        </div>
                        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            <div style={{ fontSize: '14px', fontWeight: 900, color: rarityColor, textTransform: 'uppercase', letterSpacing: '3px', marginBottom: '6px' }}>
                                {(() => {
                            ...
                            <div style={{ fontSize: '26px', fontWeight: 900, color: '#fff', fontFamily: "'Cinzel', serif", lineHeight: 1.1 }}>{itemData.name}</div>
                        </div>
                    </div>
