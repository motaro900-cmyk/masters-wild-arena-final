            ...
            >
                ...
                >
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                        ...
                        <DetailStat icon="⚔️" label="СИЛА АТАКИ (BASE)" value={hero.stats.attack} color="#f97316" />
                        <DetailStat icon="🛡️" label="ЗАЩИТА (BASE)" value={hero.stats.defense} color="#3b82f6" />
                        <DetailStat icon="🌪️" label="СКОРОСТЬ (BASE)" value={hero.stats.speed} color="#22c55e" />
                        <DetailStat icon="💥" label="КРИТ. ШАНС" value={`${hero.stats.critChance}%`} color="#a855f7" />
                    </div>
                                    ...
                                    panda: [
                                        {
                                            icon: '🎋',
                                            name: 'Двойной удар',
                                            desc: 'Наносит 180% урона и глушит врага на 1 ход.',
                                        },
                                        {
                                            icon: '🏮',
                                            name: 'Духовный щит',
                                            desc: 'Повышает защиту на 40% и восстанавливает здоровье.',
                                        },
                                        {
                                            icon: '🌀',
                                            name: 'Ураган лап',
                                            desc: 'Рассекающий удар, наносящий 120% урона всем врагам.',
                                        },
                                    ],
                                    tiger_warrior: [
                                        {
                                            ...
                                            desc: 'Повышает атаку на 30% на 2 хода.',
                                        },
                                        {
                                            icon: '🪓',
                                            name: 'Удар секиры',
                                            desc: 'Наносит 150% урона и накладывает кровотечение.',
                                        },
                                        {
                                            icon: '⚡',
                                            name: 'Быстрый выпад',
                                            desc: 'Быстрая атака с шансом критического урона +50%.',
                                        },
                                    ],
                                    minotaur: [
                                        {
                                            icon: '🐂',
                                            name: 'Дикий натиск',
                                            desc: 'Пробивает броню цели на 50% и наносит урон.',
                                        },
                                        {
                                            icon: '🛡️',
                                            name: 'Руническая броня',
                                            desc: 'Поглощает 30% входящего урона в течение 3 ходов.',
                                        },
                                        {
                                            icon: '🔨',
                                            name: 'Дрожь земли',
                                            desc: 'Атакует землю, снижая ловкость врагов на 40%.',
                                        },
                                    ],
                                    raccoon: [
                                        {
                                            icon: '🦝',
                                            name: 'Теневой шаг',
                                            desc: 'Позволяет уклониться от следующей атаки врага.',
                                        },
                                        {
                                            icon: '🗡️',
                                            name: 'Костяные клинки',
                                            desc: 'Наносит быстрый удар с шансом критического урона +50%.',
                                        },
                                        {
                                            icon: '🌀',
                                            name: 'Веер лезвий',
                                            desc: 'Быстрая атака по всем целям, снижающая их защиту на 20%.',
                                        },
                                    ],
                                    lion_knight: [
                                        {
                                            icon: '🦁',
                                            name: 'Царский рык',
                                            desc: 'Снижает защиту всех врагов на 30% на 2 хода.',
                                        },
                                        {
                                            icon: '☀️',
                                            name: 'Солнечный клинок',
                                            desc: 'Удваивает силу следующего критического удара.',
                                        },
                                        {
                                            icon: '⚔️',
                                            name: 'Золотой коготь',
                                            desc: 'Мощный удар, полностью игнорирующий броню.',
                                        },
                                    ],
                                };
