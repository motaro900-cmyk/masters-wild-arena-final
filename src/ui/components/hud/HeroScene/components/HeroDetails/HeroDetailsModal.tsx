                        ...
                        <div style={{ display: 'flex', gap: '20px' }}>
                            {(() => {
                                const HERO_SKILLS: Record<string, { icon: string; name: string; desc: string }[]> = {
                                    ...
                                    tiger_warrior: [
                                        { icon: '🐯', name: 'Ярость джунглей', desc: 'Повышает атаку на 30% на 2 хода.' },
                                        { icon: '🪓', name: 'Удар секиры', desc: 'Наносит 150% урона и накладывает кровотечение.' },
                                    ...
                                    minotaur: [
                                        ...
                                        { icon: '🛡️', name: 'Руническая броня', desc: 'Поглощает 30% входящего урона в течение 3 ходов.' },
                                        { icon: '🔨', name: 'Дрожь земли', desc: 'Атакует землю, снижая ловкость врагов на 40%.' }
                                    ],
                                    raccoon: [
                                        { icon: '🦝', name: 'Теневой шаг', desc: 'Позволяет уклониться от следующей атаки врага.' },
                                        { icon: '🗡️', name: 'Костяные клинки', desc: 'Наносит быстрый удар с шансом критического урона +50%.' },
                                        { icon: '🌀', name: 'Веер лезвий', desc: 'Быстрая атака по всем целям, снижающая их защиту на 20%.' }
                                    ],
                                    lion_knight: [
                                        { icon: '🦁', name: 'Царский рык', desc: 'Снижает защиту всех врагов на 30% на 2 хода.' },
                                        { icon: '☀️', name: 'Солнечный клинок', desc: 'Удваивает силу следующего критического удара.' },
