...
export function HeroDetailPanel({
    ...
    const requiredRank = hero.requiredTrophies ? getRankInfo(hero.requiredTrophies) : null;
            ...
            >
                {isOwned ? (
                    ...
                    <>
                        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: '4px' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                                {hero.requiredTrophies && (
                                    <span
                                        style={{
                                            color: hasEnoughTrophies ? '#a3e635' : '#ef4444',
                                            fontSize: '11px',
                                            fontWeight: 800,
                                            fontFamily: "'Nunito', sans-serif",
                                            display: 'flex',
                        ...
                        <motion.button
                            whileHover={hasEnoughTrophies ? { scale: 1.02 } : {}}
                            whileTap={hasEnoughTrophies ? { scale: 0.98 } : {}}
                            onClick={hasEnoughTrophies ? onBuy : undefined}
                            disabled={!hasEnoughTrophies}
                            style={{
                                flex: 1,
                                padding: '12px 0',
                                background: !hasEnoughTrophies
                                    ? 'rgba(239, 68, 68, 0.08)'
                                ...
                                fontSize: '13px',
                                fontWeight: 900,
                                cursor: hasEnoughTrophies ? 'pointer' : 'not-allowed',
                                fontFamily: "'Cinzel', serif",
                                letterSpacing: '1px',
                                boxShadow: !hasEnoughTrophies
                                    ? 'none'
                                    : hero.unlockType === 'diamonds'
                        ...
                        >
                            {hasEnoughTrophies ? '🔓 РАЗБЛОКИРОВАТЬ' : `🔒 РАНГ: ${requiredRank?.name}`}
                        </motion.button>
                    </>
                )}
            </div>
