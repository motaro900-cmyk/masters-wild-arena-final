        ...
        <motion.div
            ...
            style={{
                ...
                boxShadow: isActive
                    ...
                    : `0 10px 30px rgba(0,0,0,0.5), inset 0 0 15px ${color}11`,
                        ...
                        {isGold || isDiamond ? (
                            ...
                            >
                                ...
                                <img
                                    ...
                                    alt=""
                                />
                                <span style={{ color: canAfford ? '#fff' : '#ff8888', fontWeight: 900 }}>
                                    {hero.unlockCost}
                                </span>
                            </motion.button>
                        ) : (
                                    ...
                                    <div style={{ width: '100%' }}>
                                        ...
                                        >
                                            <motion.div
                                                initial={{ width: 0 }}
                                                animate={{
                                                    width: `${(achievementProgress.current / achievementProgress.max) * 100}%`,
                                                }}
                                                transition={{ duration: 0.8, ease: 'easeOut' }}
                                                style={{
                                                    height: '100%',
                                                    background: `linear-gradient(90deg, ${color}dd, ${color}66)`,
                                                    borderRadius: '4px',
