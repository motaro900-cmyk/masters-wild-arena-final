    ...
    return (
        <div
            ...
            style={{
                ...
                gap: '12px',
                overflow: 'hidden',
                boxShadow: hovered ? `0 8px 32px rgba(0,0,0,0.5), 0 0 0 1px ${color}44` : '0 4px 16px rgba(0,0,0,0.35)',
        ...
        >
            ...
            <div
                style={{
                    position: 'absolute',
                    inset: 0,
                    background: hovered ? `radial-gradient(ellipse at 0% 50%, ${color}10 0%, transparent 55%)` : 'none',
                    pointerEvents: 'none',
