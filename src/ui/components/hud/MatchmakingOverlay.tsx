    ...
    return (
        <div style={{ 
            ...
            >
                ...
                <div style={{ position: 'relative', zIndex: 1, marginTop: '200px', textAlign: 'center', width: '100%' }}>
                    
                    {/* АНИМИРОВАННЫЕ МЕЧИ С СИЯНИЕМ */}
                    <div style={{ position: 'relative', marginBottom: '40px' }}>
                        <motion.div
                            ...
                            style={{ 
                                ...
                                width: '150px', height: '150px', background: 'radial-gradient(circle, rgba(196,139,59,0.4) 0%, transparent 70%)',
