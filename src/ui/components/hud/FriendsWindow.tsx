...
export const FriendsWindow: React.FC<FriendsWindowProps> = () => {
    ...
    const fetchWorldPlayers = async () => {
        ...
        try {
            const players = await syncService.getGlobalPlayers(30);
    ...
    return (
        <div style={{
            ...
            padding: '10px 25px', display: 'flex', flexDirection: 'column', color: colors.text, fontFamily: "'Nunito', sans-serif"
        }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', marginBottom: 20 }}>
                <div style={{ display: 'flex', gap: '15px' }}>
                    <div style={{ position: 'relative', flex: 1 }}>
                        <span style={{ position: 'absolute', left: 15, top: '50%', transform: 'translateY(-50%)', opacity: 0.4, fontSize: 16 }}>🔍</span>
                        <input 
                            ...
                            style={{
                                width: '100%', padding: '14px 45px 14px 45px', background: colors.inputBg,
            ...
            >
                ...
                {activeTab === 'REWARDS' ? (
                        ...
                        <div style={{ textAlign: 'center', padding: '20px 0', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                             <div style={{ fontFamily: "'Cinzel', serif", fontSize: 20, color: colors.accent, marginBottom: 8, letterSpacing: '2px', fontWeight: 900 }}>
                                НАГРАДЫ ЗА ДРУЗЕЙ
                            </div>
                            ...
                            <div style={{ 
                                ...
                                {[
                                    ...
                                    <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 5, zIndex: 1 }}>
                                        <div style={{ 
                                            fontSize: 10, fontWeight: 900, color: colors.accent, 
                                            background: 'rgba(0,0,0,0.6)', padding: '2px 8px', borderRadius: 10, marginBottom: 5 
                                        }}>
                                            {step.count} ДРУГ
                                        </div>
                                        <div style={{ position: 'relative', width: 50, height: 50, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                            <img src={step.icon} style={{ width: '100%', height: '100%', objectFit: 'contain' }} alt="reward" />
                                            <div style={{ 
                                                position: 'absolute', bottom: -5, right: -5, background: '#000', 
                                                color: '#fff', fontSize: 10, fontWeight: 900, padding: '1px 5px', 
                                                borderRadius: 4, border: `1px solid ${colors.accent}` 
                                            }}>
                                                x{step.reward}
                                            </div>
                                        </div>
                                ...
                                <div style={{ position: 'absolute', top: '55%', left: '15%', right: '15%', height: 2, background: colors.border, zIndex: 0 }} />
                            </div>
                            ...
                            <motion.button 
                                ...
                                style={{
                                    ...
                                    border: `1px solid #ffcc00`, borderRadius: 12, color: '#1a1008', 
                                    fontWeight: 950, cursor: 'pointer', fontFamily: "'Cinzel', serif", fontSize: 14,
                                    boxShadow: '0 8px 20px rgba(0,0,0,0.4)', letterSpacing: '1px',
                                    marginBottom: 30
                                }}
                            >
                                ПРИГЛАСИТЬ ЕЩЁ
                            ...
                            <div style={{ textAlign: 'center', width: '100%' }}>
                                <div style={{ fontFamily: "'Cinzel', serif", fontSize: 16, color: colors.accent, marginBottom: 15, letterSpacing: '1px', fontWeight: 900 }}>
                                    СОЦИАЛЬНЫЕ БОНУСЫ
                                </div>
                                <div style={{ display: 'flex', gap: 10 }}>
                                    <button 
                                        ...
                                        style={{ 
                                            flex: 1, padding: '15px', background: 'rgba(240,192,64,0.1)', 
                                            border: `1px solid ${colors.accent}`, borderRadius: 12, color: colors.accent,
                                            fontSize: 11, fontWeight: 900, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8
                                        }}
                                    >
                                        ⭐ В ИЗБРАННОЕ (+50 💎)
                                    </button>
                                    <button 
                                        ...
                                        style={{ 
                                            flex: 1, padding: '15px', background: 'rgba(0,119,255,0.1)', 
                                            border: `1px solid #0077ff`, borderRadius: 12, color: '#0077ff',
                                            fontSize: 11, fontWeight: 900, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8
                                        }}
                                    >
                                        👥 НАША ГРУППА (+50 💎)
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 8, minHeight: '400px' }}>
                            {isLoadingWorld ? (
                                <div style={{ textAlign: 'center', padding: '40px', color: colors.accent, fontWeight: 800 }}>ЗАГРУЗКА ИГРОКОВ...</div>
                            ) : (
                                <>
                                    {paginatedPlayers.map((p: any) => (
                                        <motion.div 
                                            ...
                                            style={{
                                                ...
                                                borderRadius: 12, padding: '10px 15px', display: 'flex', alignItems: 'center', gap: 12,
                                                transition: 'all 0.2s'
                                            }}
                                        ...
                                        >
                                            <div style={{ 
                                                width: 45, height: 45, background: '#1a1008', borderRadius: 8,
                                            ...
                                            <div style={{ flex: 1 }}>
                                                <div style={{ fontFamily: "'Cinzel', serif", fontSize: 13, fontWeight: 700, color: '#fff' }}>
                                                    {p.name ? p.name.split(' ')[0] : 'Мастер'}
                                                </div>
                                                <div style={{ fontSize: 9, opacity: 0.6 }}>ID: {p.id} • LVL {p.level || 1}</div>
                                            </div>
                                            <motion.button 
                                                ...
                                                style={{ width: 32, height: 32, background: colors.accent, border: 'none', borderRadius: 6, cursor: 'pointer', fontSize: 14, color: '#000', fontWeight: 900 }}
                                            >
                                                +
                                            </motion.button>
                                        </motion.div>
                                    ...
                                    {/* PAGINATION CONTROLS */}
                                    {totalPages > 1 && (
                                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 15, marginTop: '15px', padding: '10px 0' }}>
                                            <button 
                                                disabled={currentPage === 1}
                                                onClick={() => setCurrentPage(prev => prev - 1)}
                                                style={{ 
                                                    background: 'rgba(255,255,255,0.05)', border: `1px solid ${colors.border}`, 
                                                    color: colors.accent, padding: '5px 12px', borderRadius: 6, cursor: 'pointer',
                                                    opacity: currentPage === 1 ? 0.3 : 1, fontSize: 11, fontWeight: 900
                                                }}
                                            >
                                                НАЗАД
                                            </button>
                                            ...
                                            <button 
                                                ...
                                                style={{ 
                                                    background: 'rgba(255,255,255,0.05)', border: `1px solid ${colors.border}`, 
                                                    color: colors.accent, padding: '5px 12px', borderRadius: 6, cursor: 'pointer',
                                                    opacity: currentPage === totalPages ? 0.3 : 1, fontSize: 11, fontWeight: 900
                                                }}
                                            >
                                                ВПЕРЕД
                                            </button>
                    ...
                    ) : (filteredFriends.length > 0 || (searchQuery.length >= 4 && searchQuery.toUpperCase().startsWith('MW-'))) ? (
                        <>
                            {/* LOCAL RESULTS */}
                                ...
                                >
                                    ...
                                    <div style={{ flex: 1 }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 2 }}>
                                            <span style={{ fontFamily: "'Cinzel', serif", fontSize: 15, fontWeight: 700, color: isLight ? '#5d4037' : '#fff' }}>
                                        ...
                                        <div style={{ fontSize: 10, opacity: 0.5, fontWeight: 700, display: 'flex', alignItems: 'center', gap: 5 }}>
                                            {f.online ? <span style={{ color: '#22c55e' }}>● В СЕТИ</span> : <span>БЫЛ(А) {f.lastSeen || 'НЕДАВНО'}</span>}
                                            • ID: {f.id}
                                        </div>
                                    </div>
                                    ...
                                    <div style={{ display: 'flex', gap: 8 }}>
                                        {activeTab === 'REQUESTS' ? (
                                            <>
                                                <button onClick={() => acceptFriendRequest(f.id)} style={{ width: 40, height: 40, background: '#22c55e', border: 'none', borderRadius: 10, cursor: 'pointer', fontSize: 18, color: '#fff' }}>✓</button>
                                                <button onClick={() => declineFriendRequest(f.id)} style={{ width: 40, height: 40, background: 'rgba(255,255,255,0.05)', border: `1px solid ${colors.border}`, borderRadius: 10, cursor: 'pointer', fontSize: 18, color: '#ff4444' }}>×</button>
                                            </>
                                        ) : (
                                            <>
                                                <motion.button 
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        if (f.id.startsWith('vk-') || f.vkId) {
                                                            sendGameRequest(f.vkId || f.id.replace('vk-', ''), "Я отправил тебе подарок в Masters of the Wild! Заходи скорее!");
                                                        }
                                                    }} 
                                                    style={{ 
                                                        width: 42, 
                                                        height: 42, 
                                                        background: f.giftSent ? 'rgba(255,255,255,0.05)' : 'rgba(240,192,64,0.1)', 
                                                ...
                                                <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} style={{ width: 42, height: 42, background: 'rgba(255,255,255,0.05)', border: `1px solid ${colors.border}`, borderRadius: 12, cursor: 'pointer', fontSize: 20, color: colors.text }}>⚔️</motion.button>
                                                <button onClick={() => removeFriend(f.id)} style={{ width: 42, height: 42, background: 'none', border: 'none', cursor: 'pointer', fontSize: 18, color: '#ff4444', opacity: 0.4 }}>🗑️</button>
                                            </>
                                        )}
                                    </div>
                                </div>
                            ...
                            {foundPlayer && (
                                <motion.div 
                                    ...
                                    style={{
                                        background: 'rgba(240,192,64,0.05)', border: `2px solid ${colors.accent}`,
                                        borderRadius: 12, padding: '15px', display: 'flex', alignItems: 'center', gap: 15, marginTop: 10
                                    }}
                                >
                                    <div style={{ position: 'relative' }}>
                                        <div style={{ 
                                            width: 55, height: 55, background: '#1a1008', borderRadius: 10,
                                            border: `2px solid ${colors.accent}`, overflow: 'hidden', padding: 2
                                        }}>
                                            <div style={{
                                                width: '100%', height: '100%', borderRadius: 6, overflow: 'hidden',
                                    ...
                                    <div style={{ flex: 1 }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 2 }}>
                                            <span style={{ fontFamily: "'Cinzel', serif", fontSize: 15, fontWeight: 700, color: colors.accent }}>{foundPlayer.name ? foundPlayer.name.split(' ')[0] : 'Мастер'}</span>
                                            <span style={{ fontSize: 9, fontWeight: 900, background: 'rgba(240,192,64,0.1)', color: colors.accent, padding: '2px 6px', borderRadius: 4, border: `1px solid ${colors.border}` }}>
                                    ...
                                    <motion.button 
                                        ...
                                        style={{
                                            padding: '10px 15px', background: colors.accent, border: 'none', borderRadius: 8,
                                            color: '#000', fontWeight: 900, cursor: 'pointer', fontSize: 10, fontFamily: "'Cinzel', serif"
                                        }}
                                    >
                                        ДОБАВИТЬ
                                    </motion.button>
                            ...
                            {isSearching && (
                                <div style={{ textAlign: 'center', padding: '20px', color: colors.accent, fontSize: '12px', fontWeight: 800 }}>ПОИСК ИГРОКА...</div>
                            )}

                            {!isSearching && !foundPlayer && searchQuery.length >= 3 && filteredFriends.length === 0 && (
                                <div style={{ textAlign: 'center', padding: '20px', opacity: 0.5, fontSize: '12px' }}>НИЧЕГО НЕ НАЙДЕНО</div>
                            )}
                        </>
                    ) : (
                        <div style={{ textAlign: 'center', padding: '40px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <motion.div 
                                animate={{ y: [0, -10, 0], filter: ['drop-shadow(0 0 10px rgba(240,192,64,0.1))', 'drop-shadow(0 0 25px rgba(240,192,64,0.4))'] }}
                                transition={{ repeat: Infinity, duration: 3, ease: "easeInOut" }}
                                style={{ marginBottom: 15 }}
                            >
                                <img src={AssetsMap.UI.ICON_FRIENDS} style={{ width: 100, height: 100, objectFit: 'contain' }} alt="friends" />
                            </motion.div>
                            <div style={{ fontFamily: "'Cinzel', serif", fontSize: 22, color: colors.accent, marginBottom: 8, letterSpacing: '2px', fontWeight: 900 }}>ВАШИ СОЮЗНИКИ ЖДУТ</div>
                            <p style={{ fontSize: 14, opacity: 0.8, marginBottom: 25, lineHeight: '1.5', maxWidth: '80%', fontWeight: 600 }}>
                                Вместе выживать в дикой природе легче! Приглашайте друзей и получайте ценные дары.
                            </p>
                            <motion.button 
                                whileHover={{ scale: 1.05, boxShadow: '0 0 25px rgba(240,192,64,0.5)' }} whileTap={{ scale: 0.95 }}
                                onClick={() => showInviteBox()}
                                style={{ padding: '18px 50px', background: 'linear-gradient(180deg, #f0c040 0%, #a88020 100%)', border: `1px solid #ffcc00`, borderRadius: 14, color: '#1a1008', fontWeight: 950, cursor: 'pointer', fontFamily: "'Cinzel', serif", fontSize: 15, boxShadow: '0 8px 20px rgba(0,0,0,0.4)', letterSpacing: '1px' }}
                            >
                                ПРИГЛАСИТЬ ДРУЗЕЙ
                            </motion.button>
                        </div>
