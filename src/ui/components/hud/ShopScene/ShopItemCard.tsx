    ...
    ({ item, isSelected, playerLevel, discount = 0, onClick, isMobile = false }) => {
        ...
        const price =
            hasDiscount && originalPrice
                ? Math.max(1, Math.round(originalPrice * (1 - discount / 100)))
                : originalPrice;
                ...
                style={{
                    ...
                    border: isSelected
                        ...
                        : discount > 0 && !isLocked
                          ...
                          : isLocked
                            ? isMobile
                                ? '1.5px solid rgba(240, 192, 64, 0.25)'
                    ...
                    animation:
                        isStarterPack && !isLocked
                            ? isSelected
                                ? 'starter-pack-pulse-selected 2s infinite ease-in-out'
                                : 'starter-pack-pulse 2s infinite ease-in-out'
                            : undefined,
                }}
            >
                {discount > 0 && !isLocked && (
