                ...
                >
                    ...
                    <motion.div
                        ...
                        style={{
                            ...
                            borderRadius: "20px",
                            boxShadow: "0 0 60px rgba(212,175,55,0.28), 0 0 120px rgba(212,175,55,0.1), inset 0 0 30px rgba(0,0,0,0.6)",
                            textAlign: "center",
                            position: "relative",
                            overflow: "hidden",
                        }}
                    >
                        ...
                        <motion.div
                            ...
                            style={{
                                position: "absolute",
                                inset: 0,
                                background: "linear-gradient(105deg, transparent 35%, rgba(212,175,55,0.1) 50%, transparent 65%)",
                                pointerEvents: "none",
                            }}
                        />
                        ...
                        <motion.div
                            ...
                            style={{ fontSize: "64px", marginBottom: "12px", display: "block", lineHeight: 1 }}
                        >
                            💎
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            style={{
                                ...
                                alignItems: "center",
                                gap: "12px",
                                background: "linear-gradient(135deg, rgba(139,92,246,0.18) 0%, rgba(79,70,229,0.18) 100%)",
