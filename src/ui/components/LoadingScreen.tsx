...
const GAMEPLAY_TIPS = [
    'Совет: Экипировка существенно повышает характеристики ваших героев.',
    'Совет: Выполняйте ежедневные задания, чтобы зарабатывать золото и кристаллы.',
    'Совет: Календарь подарков обновляется каждый день. Забирайте бесплатные награды!',
    'Совет: В Магазине вы можете приобрести сундуки с ценной экипировкой.',
    'Совет: Каждое повышение уровня открывает доступ к более сильным противникам на Арене.',
    'Совет: Испытайте удачу и крутите Колесо Фортуны в окне Ежедневного Подарка для получения бонусов.',
    'Совет: Прокачивайте таланты героев, чтобы открыть новые мощные пассивные способности.',
    'Совет: Вступайте в Клан, чтобы общаться с союзниками и получать совместные бонусы.',
    'Совет: Накапливайте кубки на Арене, чтобы повышать свой ранг и открывать ценные сундуки.',
];
