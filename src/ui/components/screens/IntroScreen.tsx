  ...
  return (
    <div style={{
      ...
      <div style={{ 
        ...
        display: 'flex', 
        flexDirection: 'column',
        alignItems: 'center', // [Lead] Fixed: alignContent -> alignItems
        justifyContent: 'center',
        color: 'white',
        padding: '40px' // Added padding for safety
      }}>
        {/* CONTENT AREA - Scrolable */}
        <div style={{ 
          width: '100%',
          flex: 1, 
          display: 'flex', 
          ...
          overflowY: 'auto', 
          padding: '10px 0',
          marginBottom: '20px' // Space for fixed button area
          ...
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                <div style={{ color: '#ffd700', fontSize: '18px', letterSpacing: '0.4em', marginBottom: '15px', textTransform: 'uppercase' }}>История Создания</div>
                <h1 style={{ fontSize: '42px', margin: '0 0 20px 0', lineHeight: 1.1, textShadow: '0 5px 15px rgba(0,0,0,1)' }}>Добро пожаловать, путник!</h1>
                <p style={{ fontSize: '18px', lineHeight: 1.6, color: 'rgba(255,255,255,0.9)', textAlign: 'justify' }}>
            ...
            {step === 2 && (
              ...
              >
                <div style={{ color: '#ffd700', fontSize: '22px', letterSpacing: '0.5em', marginBottom: '20px', textTransform: 'uppercase' }}>Основы Мастерства</div>
                <h2 style={{ fontSize: '48px', marginBottom: '30px', color: 'white' }}>Что нужно знать?</h2>
                <div style={{ textAlign: 'left', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  <div style={{ background: 'rgba(255,255,255,0.05)', padding: '20px', borderRadius: '20px', borderLeft: '4px solid #ffd700' }}>
                    <strong style={{ color: '#ffd700', fontSize: '22px' }}>🛡️ Победа в подготовке:</strong> <span style={{ fontSize: '18px', color: '#ddd' }}>Битвы на арене проходят автоматически. Твоя главная задача — собрать идеальный билд из оружия и доспехов *до* начала боя.</span>
                  </div>
                  <div style={{ background: 'rgba(255,255,255,0.05)', padding: '20px', borderRadius: '20px', borderLeft: '4px solid #ffd700' }}>
                    <strong style={{ color: '#ffd700', fontSize: '22px' }}>⚡ Баланс характеристик:</strong> <span style={{ fontSize: '18px', color: '#ddd' }}>Сила увеличивает урон, Ловкость — шанс крита и скорость, а Стойкость — твое здоровье. Ищи баланс, подходящий под твоего героя.</span>
                  </div>
                  <div style={{ background: 'rgba(255,255,255,0.05)', padding: '20px', borderRadius: '20px', borderLeft: '4px solid #ffd700' }}>
                    <strong style={{ color: '#ffd700', fontSize: '22px' }}>💎 Редкость имеет значение:</strong> <span style={{ fontSize: '18px', color: '#ddd' }}>Предметы с золотыми и фиолетовыми рамками намного сильнее обычных. Даже одна такая вещь может переломить ход всего сражения.</span>
                  </div>
                  <div style={{ background: 'rgba(255,255,255,0.05)', padding: '20px', borderRadius: '20px', borderLeft: '4px solid #ffd700' }}>
                    <strong style={{ color: '#ffd700', fontSize: '22px' }}>📜 Квесты и Энергия:</strong> <span style={{ fontSize: '18px', color: '#ddd' }}>Каждый бой тратит энергию. Чтобы не терять темп, выполняй ежедневные квесты — это твой главный источник золота и алмазов.</span>
                  </div>
                </div>
              </motion.div>
            )}
            ...
            {step === 3 && (
              ...
              >
                <h2 style={{ fontSize: '42px', textAlign: 'center', marginBottom: '40px', color: '#ffd700' }}>Путеводитель Мастера</h2>
                ...
                <div style={{ textAlign: 'center', marginTop: '40px', fontSize: '20px', color: 'rgba(255,255,255,0.7)', fontWeight: 'bold' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', paddingBottom: '20px' }}>
          ...
          <div style={{ marginTop: '15px', color: 'rgba(255,255,255,0.4)', fontSize: '14px', letterSpacing: '0.1em' }}>
            ШАГ {step} ИЗ 3
          </div>
        </div>
      </div>
