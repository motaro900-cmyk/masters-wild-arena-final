    ...
    return (
        ...
        >
            <div 
                ...
                style={{ borderColor: '#8b5cf6', borderImageSource: 'linear-gradient(180deg, #d4b483 0%, #5e4125 100%)', borderImageSlice: 1 }}
            >
                {/* Заголовок */}
                <div className="bg-gradient-to-b from-[#2a1f16] to-[#16110d] border-b-2 border-[#5e4125] flex justify-between items-center px-8 py-4 relative">
                    <h2 className="text-[#facc15] font-black text-2xl tracking-widest uppercase drop-shadow-md">{title}</h2>
                    <button onClick={handleClose} className="w-10 h-10 bg-[#3a2818] hover:bg-[#dc2626] border-2 border-[#78350f] hover:border-white rounded-full flex items-center justify-center text-white font-black text-xl transition-colors active:scale-90">
                        ✕
                    </button>
                </div>
