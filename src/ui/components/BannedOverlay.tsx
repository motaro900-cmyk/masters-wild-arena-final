        ...
        <AnimatePresence>
            {isBanned && (
                ...
                >
                    ...
                    >
                        ...
                        {banUntil && (
                            ...
                            >
                                ...
                                {banUntil === 'perm' ? 'Перманентно (навсегда)' : banUntil}
                            </p>
                        )}
                    </div>
                    <p
                    ...
                    >
                        Если вы считаете, что блокировка была выдана по ошибке, обратитесь в поддержку
                        игры или напишите разработчикам.
                    </p>
                </motion.div>
            )}
        </AnimatePresence>
