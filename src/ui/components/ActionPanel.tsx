            ...
            <div className="bg-[#1c1f26] border-[3px] border-[#3d4149] w-[680px] h-[150px] rounded-[24px] p-3.5 flex flex-col justify-between shadow-[0_15px_40px_rgba(0,0,0,0.8)]">
                ...
                <div className="flex items-center justify-between px-2">
                    <div className="flex items-center gap-2">
                        <div className="w-7 h-7 bg-gradient-to-b from-yellow-300 to-yellow-600 rounded-full flex items-center justify-center text-black font-black text-base italic shadow-lg border border-yellow-200">
                            S
                        </div>
                    ...
                    <div className="flex-1 mx-6 relative h-1 bg-black/60 rounded-full border border-white/5 overflow-hidden">
                        <div
                            className="h-full bg-gradient-to-r from-orange-400 to-orange-600 shadow-[0_0_8px_rgba(249,115,22,0.8)]"
                            style={{ width: '90%' }}
                        />
                    </div>
                    <div className="flex items-center gap-2">
                        <span className="text-xs font-black text-slate-400 uppercase italic opacity-80">
                            ДАЛЕЕ: 1,500
                        </span>
                ...
                <div className="flex gap-2.5 h-[65px]">
                    <button className="flex-1 bg-gradient-to-b from-[#2c3340] to-[#1a1e26] border-[2px] border-[#3d4659] rounded-xl flex flex-col items-center justify-center transition-all hover:brightness-125 group">
                        <span className="text-[7px] font-black text-slate-500 uppercase tracking-tighter mb-0.5 opacity-80">
                            БЕЗ РЕЙТИНГА
                        </span>
                        <span className="text-xl font-black text-white uppercase italic tracking-widest leading-none group-hover:scale-105 transition-transform">
                            РАЗМИНКА
                        </span>
                    </button>
                    ...
                    >
                        <div
                            className="w-full h-full bg-gradient-to-b from-[#ffed47] via-[#f29100] to-[#d66e00] border-b-[6px] border-[#8b4513] flex items-center justify-center gap-5 shadow-xl"
                            style={{
                        ...
                        >
                            ...
                            <div className="flex flex-col items-start leading-none text-left">
                                <span className="text-4xl font-black text-black uppercase italic tracking-tighter leading-none">
                                    В БОЙ!
                                </span>
                                <p className="text-[7px] font-black text-black/50 uppercase tracking-[0.4em] mt-1 ml-0.5">
                                    НА КУБКИ
                                </p>
                            </div>
                        </div>
