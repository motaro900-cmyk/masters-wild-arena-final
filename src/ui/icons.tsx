...
export const SVG_ICONS: Record<string, string> = {
  ...
  Settings: "M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z",
  MessageCircle: "M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z",
  Calendar: "M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20a2 2 0 002 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zm0-12H5V6h14v2z",
  ...
  Lock: "M19 11H5c-1.1 0-2 .9-2 2v7c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-7c0-1.1-.9-2-2-2zm-7 5.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5zM17 11V7c0-2.76-2.24-5-5-5S7 4.24 7 7v4h10z",
};
...
export const Juicy3DIcon: React.FC<{ type: string, size?: number }> = ({ type, size = 36 }) => {
  if (type === 'Coins') return (
    <svg width={size} height={size} viewBox="0 0 32 32">
      <defs><linearGradient id="goldG" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#FFF8B0" /><stop offset="50%" stopColor="#FFD700" /><stop offset="100%" stopColor="#D2691E" /></linearGradient></defs>
      <circle cx="16" cy="16" r="14" fill="url(#goldG)" stroke="#B8860B" strokeWidth="1"/>
    </svg>
  );
  if (type === 'Zap') return (
    <svg width={size} height={size} viewBox="0 0 32 32">
      <defs><linearGradient id="zapG" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#FFF8B0" /><stop offset="50%" stopColor="#FFD700" /><stop offset="100%" stopColor="#FF8C00" /></linearGradient></defs>
      <path d="M18 2 L6 18 h8 L10 30 L26 14 h-8 Z" fill="url(#zapG)" stroke="#B8860B" strokeWidth="1"/>
    </svg>
  );
  if (type === 'Gem') return (
    <svg width={size} height={size} viewBox="0 0 32 32">
      <defs><linearGradient id="gemG" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#E0B0FF" /><stop offset="50%" stopColor="#8A2BE2" /><stop offset="100%" stopColor="#4B0082" /></linearGradient></defs>
