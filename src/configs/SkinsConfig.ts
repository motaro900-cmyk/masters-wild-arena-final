...
export const SKINS_DB: ISkinConfig[] = [
    ...
    },
    {
        ...
        description: 'Хранитель Лабиринта',
        heroId: 'minotaur',
    ...
    {
        id: 'tiger_warrior_default',
        name: 'Повелитель Джунглей',
        description: 'Повелитель Джунглей',
    ...
    {
        id: 'lion_knight_default',
        name: 'Лорд Прайда',
        description: 'Лорд Прайда',
        heroId: 'lion_knight',
    ...
    // ── 5 НОВЫХ ГЕРОЕВ ─────────────────────────────────────────────────
    {
        ...
        image: '/assets/characters/shadow_dancer/shadow_dancer_base.png',
        source: 'default',
        sourceLabel: 'По умолчанию',
        rarity: 'COMMON',
    },
    {
        ...
        image: '/assets/characters/crystal_guardian/crystal_guardian_base.png',
        source: 'default',
        sourceLabel: 'По умолчанию',
        rarity: 'COMMON',
    },
    {
        ...
        heroId: 'storm_caller',
        image: '/assets/characters/storm_caller/storm_caller_base.png',
        source: 'default',
        sourceLabel: 'По умолчанию',
        rarity: 'COMMON',
    },
    {
        ...
        image: '/assets/characters/nature_warden/nature_warden_base.png',
        source: 'default',
        sourceLabel: 'По умолчанию',
        rarity: 'COMMON',
    },
    {
        ...
        heroId: 'void_walker',
        image: '/assets/characters/void_walker/void_walker_base.png',
        source: 'default',
        sourceLabel: 'По умолчанию',
        rarity: 'COMMON',
    },
