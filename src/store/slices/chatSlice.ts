    ...
    clanMessages: [
        {
            ...
            author: 'Алексей',
            role: 'OFFICER',
            text: 'Всем привет! Готовимся к осаде в 20:00.',
        ...
        },
        {
            ...
            author: 'Дмитрий',
            role: 'MEMBER',
            text: 'Да, я уже собрал нужные зелья и экипировку.',
        ...
        },
        {
            ...
            author: 'София',
            role: 'OFFICER',
            text: 'Отлично! Не забудьте сделать ежедневные взносы золота.',
    ...
    sendFeedback: (category: string, text: string) => {
        ...
        const feedbackData = {
            ...
            debugDump: {
                ...
                selectedHeroId: state.selectedHeroId || 'panda',
                activeScreen: state.activeScreen || 'MAIN_MENU',
                combatLogs: (state.combatLogs || []).slice(-20),
