...
const tiger = { id: 'tiger_warrior', stats: { strength: 16, agility: 24, stamina: 16 }, role: 'ASSASSIN' };
const raccoon = { id: 'raccoon', stats: { strength: 15, agility: 23, stamina: 16 }, role: 'ASSASSIN' };

console.log("=== PRECISE SCANNING RACCOON STATS ===");
